...
import 'package:youtube/features/homepage/controller/comment_controller.dart';
...
class YoutubeDetail extends GetView<YoutubeDetailController> {
  final CommentController controller2 = Get.put(CommentController());
                      ...
                      children: <Widget>[
                        new Row(
                          children: <Widget>[
                            ...
                            IconButton(
                                onPressed: () {
                                  controller2.saveComment(commint.text);
                                },
